...
public interface FilterConfiguration {
    ...
    /**
     * Возвращает список паттернов для приоритетных файлов.
     * Файлы, соответствующие этим паттернам, считаются приоритетными,
     * но не исключаются, если не соответствуют им.
     *
    ...
    /**
     * Возвращает список паттернов для жёстко исключаемых файлов.
     * Файлы, соответствующие этим паттернам, будут исключены из анализа.
     *
     * @return Список glob-паттернов.
     */
    ...
    /**
     * Возвращает список расширений файлов, которые нужно исключить.
     * Эти расширения исключаются ДО проверки сложных паттернов exclude.
     * Расширения должны быть в нижнем регистре и начинаться с точки (например, ".jar").
     *
