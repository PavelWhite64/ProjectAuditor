...
/**
 * Стратегия генерации отчетов.
 * Соответствует принципу Open-Closed - можно добавлять новые форматы без изменения существующего кода.
 */
public interface ReportStrategy {
     ...
     * Генерирует отчет
     */
    void generateReport(AnalysisResult result, AnalysisConfig config, Path outputDir, String outputFileName);
