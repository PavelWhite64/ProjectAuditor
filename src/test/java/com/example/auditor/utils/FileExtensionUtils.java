...
class FileExtensionUtilsTest extends ProjectAuditorTest {
  ...
  void shouldExtractExtensionsCorrectly(
      String filename, String withoutDot, String withDot, String lowercase) {
    ...
    assertThat(
            FileExtensionUtils.getExtension(
                filename, FileExtensionUtils.ExtensionFormat.WITHOUT_DOT))
        .isEqualTo(withoutDot);
    assertThat(
            FileExtensionUtils.getExtension(filename, FileExtensionUtils.ExtensionFormat.WITH_DOT))
        .isEqualTo(withDot);
    assertThat(
            FileExtensionUtils.getExtension(filename, FileExtensionUtils.ExtensionFormat.LOWERCASE))
        .isEqualTo(lowercase);
  }
  ...
  void shouldHandleNullInputs() {
    assertThat(
            FileExtensionUtils.getExtension(null, FileExtensionUtils.ExtensionFormat.WITHOUT_DOT))
        .isEqualTo("");
